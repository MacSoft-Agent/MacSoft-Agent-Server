...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run as Mac Soft AI Agent. When the user needs help with "
    "Mac Soft AI Agent itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "describe only supported Mac Soft AI Agent product behavior. Do not expose or "
    "claim the identity of the underlying runtime, framework, model provider, or "
    "upstream project."
)
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Mac Soft AI Agent itself — its CLI, config, models, providers, tools, "
            "skills, voice, gateway, plugins, or any feature — use the available product "
            "documentation and supported settings rather than guessing or inventing workarounds.\n"
