...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  serverAutoCount: {
    load: () => ipcRenderer.invoke('hermes:server-autocount:load'),
    loadModel: () => ipcRenderer.invoke('hermes:server-autocount:model:load'),
    refreshNetworks: () => ipcRenderer.invoke('hermes:server-autocount:refresh-networks'),
    save: payload => ipcRenderer.invoke('hermes:server-autocount:save', payload),
    saveModel: payload => ipcRenderer.invoke('hermes:server-autocount:model:save', payload),
    getPairingCode: port => ipcRenderer.invoke('hermes:server-autocount:get-pairing-code', port),
    testServer: port => ipcRenderer.invoke('hermes:server-autocount:test-server', port),
    testAiService: url => ipcRenderer.invoke('hermes:server-autocount:test-ai-service', url),
    testAutoCount: payload => ipcRenderer.invoke('hermes:server-autocount:test-autocount', payload)
  },
  macSoftHost: {
    status: () => ipcRenderer.invoke('hermes:macsoft-host:status'),
    serviceAction: (name, action) => ipcRenderer.invoke('hermes:macsoft-host:service-action', name, action),
    setAutoStart: enabled => ipcRenderer.invoke('hermes:macsoft-host:set-autostart', Boolean(enabled))
  },
  zoom: {
