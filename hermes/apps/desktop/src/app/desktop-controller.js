...
export function DesktopController() {
    ...
    useEffect(() => {
        if (shouldOpenFirstRunSettings({
            customerRuntime: macSoftCustomerRuntime,
            firstRunPending: macSoftFirstRunNavigationRef.current,
            pathname: location.pathname
        })) {
            macSoftFirstRunNavigationRef.current = false;
            navigate(`${SETTINGS_ROUTE}?tab=server-autocount`, { replace: true });
        }
    ...
    useGatewayBoot({
        disabled: macSoftCustomerRuntime,
    ...
    const overlays = (_jsxs(_Fragment, { children: [_jsx(RemoteDisplayBanner, {}), !macSoftCustomerRuntime && !isSecondaryWindow() && _jsx(DesktopInstallOverlay, {}), !isSecondaryWindow() && (_jsx(DesktopOnboardingOverlay, { enabled: macSoftCustomerRuntime || gatewayState === 'open', onCompleted: () => {
                    void refreshHermesConfig();
                    void refreshCurrentModel();
                    void queryClient.invalidateQueries({ queryKey: ['model-options'] });
                }, requestGateway: requestGateway })), !macSoftCustomerRuntime && (_jsx(ModelPickerOverlay, { gateway: gatewayRef.current || undefined, onSelect: selectModel })), _jsx(SessionPickerOverlay, { onResume: resumeSession }), !macSoftCustomerRuntime && (_jsx(ModelVisibilityOverlay, { gateway: gatewayRef.current || undefined, onOpenProviders: openProviderSettings })), !macSoftCustomerRuntime && _jsx(UpdatesOverlay, {}), !macSoftCustomerRuntime && _jsx(GatewayConnectingOverlay, {}), !macSoftCustomerRuntime && _jsx(BootFailureOverlay, {}), _jsx(CommandPalette, {}), _jsx(PetGenerateOverlay, {}), _jsx(SessionSwitcher, {}), _jsx(FileActionDialogs, {}), _jsx(RemoteFolderPicker, {}), settingsOpen && (_jsx(Suspense, { fallback: null, children: _jsx(SettingsView, { gateway: gatewayRef.current, onClose: closeOverlayToPreviousRoute, onConfigSaved: () => {
                        void refreshHermesConfig();
                        void refreshCurrentModel();
                        void queryClient.invalidateQueries({ queryKey: ['model-options'] });
