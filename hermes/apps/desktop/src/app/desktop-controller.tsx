...
export function DesktopController() {
  ...
  const overlays = (
    <>
      <RemoteDisplayBanner />
      {!macSoftCustomerRuntime && !isSecondaryWindow() && <DesktopInstallOverlay />}
      {!isSecondaryWindow() && (
        <DesktopOnboardingOverlay
          enabled={macSoftCustomerRuntime || gatewayState === 'open'}
          onCompleted={() => {
            void refreshHermesConfig()
            void refreshCurrentModel()
      ...
      {!macSoftCustomerRuntime && <UpdatesOverlay />}
      {!macSoftCustomerRuntime && <GatewayConnectingOverlay />}
      {!macSoftCustomerRuntime && <BootFailureOverlay />}
      <CommandPalette />
      <PetGenerateOverlay />
      <SessionSwitcher />
      <FileActionDialogs />
