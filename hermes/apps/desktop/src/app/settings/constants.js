...
export const PROVIDER_GROUPS = [
    {
        prefix: 'NOUS_',
        name: 'Nous Portal',
        description: 'Hosted MacSoft Agent & Nous-trained models',
...
export const FIELD_DESCRIPTIONS = defineFieldCopy({
    ...
    timezone: 'Used when MacSoft Agent needs local time context. Blank uses the system timezone.',
    agent: {
        imageInputMode: 'Controls how image attachments are sent to the model.',
        maxTurns: 'Upper bound for tool-calling turns before MacSoft Agent stops a run.'
    },
    terminal: {
    ...
    fileReadMaxChars: 'Maximum characters MacSoft Agent can read from one file request.',
    approvals: {
        mode: 'How MacSoft Agent handles commands that need explicit approval.',
    ...
    updates: {
        nonInteractiveLocalChanges: 'When MacSoft Agent updates itself from the app (no terminal prompt), keep local source edits (stash) or throw them away (discard). Terminal updates always ask.'
    }
});
