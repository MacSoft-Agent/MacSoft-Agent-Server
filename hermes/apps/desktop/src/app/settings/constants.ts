...
export const FIELD_DESCRIPTIONS: Record<string, string> = defineFieldCopy({
  ...
  updates: {
    nonInteractiveLocalChanges:
      'When MacSoft Agent updates itself from the app (no terminal prompt), keep local source edits (stash) or throw them away (discard). Terminal updates always ask.'
  }
})
