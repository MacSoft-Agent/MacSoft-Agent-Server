...
import { hidesLegacyGatewayUi } from '../macsoft-customer-navigation';
...
export function SettingsView({ onClose, onConfigSaved, onMainModelChanged }) {
    ...
    useEffect(() => {
        if (hidesLegacyGatewayUi(macSoftCustomerRuntime, activeView)) {
            setActiveView('server-autocount');
        }
    }, [activeView, macSoftCustomerRuntime, setActiveView]);
    ...
    const navGroups = [
        ...
        ...(!hidesLegacyGatewayUi(macSoftCustomerRuntime, 'gateway')
            ? [{
