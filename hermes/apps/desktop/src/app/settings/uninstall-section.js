...
const OPTIONS = [
    {
        ...
        description: 'Remove this desktop app. The MacSoft Agent agent, your config, and chats all stay.',
    ...
    },
    {
        ...
        description: 'Remove the app and the MacSoft Agent agent, but keep config, chats, and secrets for a future reinstall.',
        consequence: 'the Chat GUI and the MacSoft Agent agent (config, chats, and secrets are kept)',
        needsAgent: true
    },
    {
        mode: 'full',
        ...
        consequence: 'EVERYTHING — the Chat GUI, the MacSoft Agent agent, and all of your config, chats, secrets, and logs',
