...
export class HermesGateway extends JsonRpcGatewayClient {
    constructor() {
        super({
            closedErrorMessage: 'MacSoft Agent gateway connection closed',
            connectErrorMessage: 'Could not connect to MacSoft Agent gateway',
            createRequestId: nextId => nextId,
            notConnectedErrorMessage: 'MacSoft Agent gateway is not connected',
