...
export const en = {
    ...
    notifications: {
        ...
        backendOutOfDateMessage: 'Your MacSoft Agent backend is older than this desktop build and may not work correctly. Update to align them.',
        ...
        errors: {
            ...
            methodNotAllowed: 'The desktop backend rejected that request (405 Method Not Allowed). Try restarting MacSoft Agent.',
    ...
    settings: {
        ...
        appearance: {
            ...
            pet: {
                title: 'Pet',
                intro: 'Adopt an animated petdex mascot that floats over the app and reacts to what MacSoft Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
                restartHint: 'Pets need a quick restart — the running app started before this feature was added. Quit and reopen MacSoft Agent, then come back here.',
                on: 'On',
                off: 'Off',
                scaleTitle: 'Size',
        ...
        about: {
            ...
            automaticUpdatesDesc: 'MacSoft Agent checks for updates automatically in the background and lets you know when one is ready.',
        ...
        gateway: {
            ...
            intro: 'MacSoft Agent starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running MacSoft Agent backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
            ...
            remoteDesc: 'Connect this desktop shell to a remote MacSoft Agent backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
        ...
        providers: {
            ...
            intro: 'Sign in with a subscription — no API key to copy. MacSoft Agent runs the browser sign-in for you, right here in the app.',
            connected: 'Connected',
            collapse: 'Collapse',
    ...
    cron: {
        ...
        newCron: 'New cron',
        emptyDescNew: 'Schedule a prompt to run on a cron expression. MacSoft Agent will run it and deliver results to the destination you pick.',
    ...
    sidebar: {
        ...
        projects: {
            ...
            staleBackend: 'Update the MacSoft Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
            deleteConfirm: 'This removes the saved project from MacSoft Agent. Files, git repos, and worktrees stay untouched.',
    ...
    updates: {
        ...
        manualBody: 'You installed MacSoft Agent from the command line, so updates run there too. Paste this into your terminal:',
        manualPickedUp: 'MacSoft Agent will pick up the new version next time you launch it.',
        guiSkewTitle: 'Update the desktop app',
        guiSkewBody: 'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the MacSoft Agent desktop app (your AppImage / .deb / .rpm) to match.',
        copy: 'Copy',
        copied: 'Copied',
        done: 'Done',
        applyingBody: 'The MacSoft Agent updater takes over in its own window and reopens MacSoft Agent automatically when it’s done. Please don’t reopen MacSoft Agent yourself while it’s updating.',
        applyingBodyBackend: 'The remote backend is applying the update and will restart. MacSoft Agent reconnects automatically when it’s back.',
    ...
    install: {
        ...
        failedDesc: 'One of the install steps failed. On Windows, this can happen if another MacSoft Agent CLI or desktop instance is running. Stop any running MacSoft Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
        activeDesc: 'This is a one-time setup. The MacSoft Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
    ...
    onboarding: {
        ...
        apiKeyOptions: {
            ...
            local: {
                short: 'self-hosted',
                description: 'Point MacSoft Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
            }
        },
        ...
        autoBrowser: provider => `We opened ${provider} in your browser. Authorize MacSoft Agent there and you'll be connected automatically — nothing to copy or paste.`,
    ...
    preview: {
        ...
        web: {
            ...
            finishedRestarting: message => `MacSoft Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
            ...
            stillWorking: 'MacSoft Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
    ...
    assistant: {
        ...
        approval: {
            ...
            alwaysDescription: pattern => `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). MacSoft Agent won’t ask again for commands like this — in this session or any future one.`,
    ...
    prompts: {
        ...
        sudoDesc: 'MacSoft Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
