...
export const en: Translations = {
  ...
  boot: {
    ready: 'MacSoft Agent is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading MacSoft Agent settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting MacSoft Agent…'
    },
    errors: {
      backgroundExited: 'MacSoft Agent background process exited.',
      backgroundExitedDuringStartup: 'MacSoft Agent background process exited during startup.',
    ...
    failure: {
      title: "MacSoft Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your MacSoft Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update MacSoft Agent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting MacSoft Agent.',
    ...
    native: {
      ...
      inputBody: 'MacSoft Agent is waiting for your response.',
      turnDoneTitle: 'MacSoft Agent finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to MacSoft Agent defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while MacSoft Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'MacSoft Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while MacSoft Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let MacSoft Agent follow your system setting.',
      fontSizeTitle: 'Font Size',
      fontSizeDesc: 'Adjust text size for readability. This setting is restored after the app restarts.',
      fontSizeOptions: {
        small: 'Small',
        normal: 'Normal',
        large: 'Large',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what MacSoft Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen MacSoft Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    serverAutoCount: {
      ...
      autoStartWithWindows: 'Auto-start services with Windows',
      administratorDetails: 'Administrator details',
      administratorDetail: 'Administrator detail',
      hostVersion: 'Host version',
      aiServicePid: 'AI Service PID',
      serverPid: 'Server PID',
      controlBoundary: 'Control boundary',
      localHostOnly: 'Local Host interface only',
      ...
      autoStartUpdateFailed: 'Auto-start could not be updated.',
      networkRefreshFailed: 'Network interfaces could not be refreshed.',
      refreshFailed: 'Refresh failed',
      clientUrlCopied: 'Client URL copied',
      copyManually: 'Copy the URL manually from the field.',
      copyFailed: 'Copy failed',
      pairingCodeFailed: 'Unable to get pairing code.',
      reviewFields: 'Review the fields and try again.',
      connectionTestFailed: 'The connection test could not be completed.',
      ...
      serverPortDesc: 'Client-facing port. MacSoft Client connects here, not to the AI Service.',
      networkInterface: 'Network interface',
      networkInterfaceDesc: 'Physical Wi-Fi or Ethernet is recommended. Virtual and VPN addresses remain selectable.',
      networkInterfaceAria: 'Selected network interface',
      networkKinds: { ethernet: 'Ethernet', other: 'Network', vpn: 'VPN', virtual: 'Virtual', wifi: 'Wi-Fi' },
      recommended: 'Recommended',
      thisComputerOnly: 'This computer only',
      clientUrl: 'Client URL',
      clientUrlDesc: 'Share this URL with MacSoft Client devices on the same local network.',
      clientUrlLocalDesc: 'Local-only URL. Other computers cannot use this address.',
      copyClientUrl: 'Copy Client URL',
      pairingCode: 'Pairing Code',
      getCode: 'Get Code',
      serverNotRunning: 'MacSoft Server is not running.',
      pairingCodeDesc: 'Request a one-time code for pairing a MacSoft Client.',
      refreshIp: 'Refresh IP',
      testServer: 'Test Server',
      advancedAiService: 'Advanced · AI Service',
      serviceUrl: 'Service URL',
      serviceUrlDesc: 'Internal service used by MacSoft Server. It is not a Client URL.',
      servicePort: 'Service port',
      servicePortDesc: 'Changing this updates the runtime API Server port and MacSoft Server URL together.',
      testAiService: 'Test AI Service',
      autoCountConnection: 'AutoCount Connection',
      cloudUrl: 'Cloud URL',
      cloudUrlDesc: 'AutoCount Cloud API base URL.',
      apiKey: 'API Key',
      existingKeyPlaceholder: 'Existing key configured · leave blank to keep',
      enterApiKeyPlaceholder: 'Enter API Key',
      hideApiKey: 'Hide API Key',
      revealApiKey: 'Reveal typed API Key',
      apiKeyDesc:
        'The existing key is never loaded into this page. Leave blank to preserve it; do not include a Bearer prefix.',
      connectorId: 'Connector ID',
      connectorIdDesc: 'Selects the registered Local Connector.',
      companyId: 'Company ID',
      companyIdDesc:
        'Selects the company/account book exposed by the Connector. Database details are read-only test results.',
      testAutoCount: 'Test AutoCount Connection',
      saveDesc:
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'MacSoft Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading MacSoft Agent configuration...',
    ...
    gateway: {
      ...
      intro:
        'MacSoft Agent starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running MacSoft Agent backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private MacSoft Agent backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote MacSoft Agent backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'MacSoft Agent will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · MacSoft Agent ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. MacSoft Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As MacSoft Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart MacSoft Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update MacSoft Agent to generate pets.',
      backgroundHint: 'You can close this — MacSoft Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure MacSoft Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `MacSoft Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent MacSoft Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. MacSoft Agent will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the MacSoft Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm:
        'This removes the saved project from MacSoft Agent. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting MacSoft Agent...',
    placeholderReconnecting: 'Reconnecting to MacSoft Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give MacSoft Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'MacSoft Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask MacSoft Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating MacSoft Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting MacSoft Agent…',
    ...
    unsupportedMessage: 'This version of MacSoft Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of MacSoft Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected MacSoft Agent backend is ready to install.',
    ...
    manualBody:
      'You installed MacSoft Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'MacSoft Agent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the MacSoft Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The MacSoft Agent updater takes over in its own window and reopens MacSoft Agent automatically when it’s done. Please don’t reopen MacSoft Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. MacSoft Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then MacSoft Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'MacSoft Agent needs a one-time install',
    ...
    settingUpTitle: 'Setting up MacSoft Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another MacSoft Agent CLI or desktop instance is running. Stop any running MacSoft Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The MacSoft Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with MacSoft Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'MacSoft Agent is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting MacSoft Agent…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run MacSoft Agent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description:
          'Point MacSoft Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — MacSoft Agent connects automatically',
    ...
    authorizeThere: 'Authorize MacSoft Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize MacSoft Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `MacSoft Agent v${version}`,
      ...
      gatewayTitle: 'MacSoft Agent inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. MacSoft Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'MacSoft Agent is restarting...',
      askRestart: 'Ask MacSoft Agent to restart the server',
      lookingRestart: taskId => `MacSoft Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'MacSoft Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message =>
        `MacSoft Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'MacSoft Agent could not restart the server.',
      stillWorking:
        'MacSoft Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'MacSoft Agent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'MacSoft Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). MacSoft Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc:
      'MacSoft Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'MacSoft Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart MacSoft Agent to use Save Image.',
    restartToSaveImages: 'Restart MacSoft Agent to save images',
