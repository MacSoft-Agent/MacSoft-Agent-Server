...
const DESKTOP_COMMAND_SPECS = [
    ...
    { name: '/profile', description: 'Switch the active MacSoft Agent profile', surface: action('profile') },
    ...
    { name: '/version', description: 'Show MacSoft Agent version', surface: exec() },
