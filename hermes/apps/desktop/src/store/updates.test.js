...
describe('startUpdatePoller', () => {
    ...
    it('does not contact the legacy updater on startup', async () => {
        startUpdatePoller();
    ...
    it('does not schedule legacy update interval checks', async () => {
        startUpdatePoller();
        await vi.advanceTimersByTimeAsync(0);
        checkMock.mockClear();
    ...
    it('does not check the legacy updater when the window regains focus', async () => {
        startUpdatePoller();
        await vi.advanceTimersByTimeAsync(0);
        checkMock.mockClear();
