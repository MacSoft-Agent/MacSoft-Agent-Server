...
PO price is 10 while the supplier invoice charges 11, and the user confirms the supplier invoice overcharges the company. This is a CN candidate. The user may contact the supplier, or authorize the Agent to draft and send an exact approved message. Keep the Case waiting for the supplier response/CN. Register the later CN, show its material facts, and ask whether that exact version is accepted before any AutoCount CN action.

## 6. Supplier document undercharges the company

PO price is 11 while the supplier invoice charges 10, and the user confirms the supplier invoice is the incorrect side. Do not automatically request a CN. Explain the undercharge and ask which approved business treatment applies. Keep the Case pending until that treatment is known.
