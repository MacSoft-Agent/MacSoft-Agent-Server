...
For MacSoft dashboards, use the MacSoft dashboard's
`echarts-implementation.md` reference. It defines option structure, field
mapping, responsive containers, and the dependency boundary. Do not embed a
third-party chart library unless the product runtime explicitly supplies it.
